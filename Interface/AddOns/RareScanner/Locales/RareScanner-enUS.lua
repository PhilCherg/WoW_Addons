...
if AL then
	...
	AL["SOUND_CUSTOM_FILE_DESC"] = "Type the name of the sound file that you copied into 'RareScannerSounds' folder. For example: 'myaudio.ogg'."
	AL["SOUND_CUSTOM_FILE_INFO"] = "Instructions"
	AL["SOUND_CUSTOM_FILE_INFO1"] = "1. Create the folder 'World of Warcraft\\_retail_\\Interface\\addons\\RareScannerSounds'"
